			...
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					...
					<?php
						...
						if($error=="true")
						{
							echo "<h3 id='errorMessage' style='color: red;'>Couldn't create the User !</h3>";
						}
					?>
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" action="../PHP/UserCreate.php" method="post" style="background: transparent;
    backdrop-filter: blur(8px);">
				<div class="wrap-input100 validate-input" data-validate = "Enter Name">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter Mail">
						<input class="input100" type="email" name="mail" placeholder="Mail">
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>
