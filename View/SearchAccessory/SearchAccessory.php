...
<body style="    margin: 0;
    ...
    <?php echo('
    <div class="bike-list">
        <button type="submit" class="btn sell-bike" id="myButton" name="submit">Search Accessory</button>
        <br>
        <div class="form-group my-form-group" style="display: flex;align-items: center;">
        <label for="AccessorySearch">Search by:</label>
        <select id="AccessorySearch" name="AccessorySearch" onchange="Select()">
    ...
    <br>
        <table class="bike-table">
          ...
          <tbody>
                ');require_once("../../View/PHP/SearcAccessory.php");
        echo('
          </tbody>
        </table>
      </div>');
