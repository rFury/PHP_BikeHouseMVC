...
<body style="    margin: 0;
    ...
    <form action="../../View/PHP/BoughtBike.php" method="post">
    <div class="bike-details">
        <h1>Bike</h1>
        <?php
            require_once("../PHP/BuyB.php");
        ?>
        <button type="submit" class="btn buy-bikeX">Buy !</button>
      </div>
      </form>
    <footer>
